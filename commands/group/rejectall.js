...
module.exports = {
    ...
    async execute(sock, msg, args) {
        try {
            ...
            await sock.groupRequestParticipantsList(jid, jids, 'reject');
            
            await sock.sendMessage(jid, { text: `❌ Rejected ${jids.length} join requests.` });
        } catch (error) {
