...
module.exports = {
    name: 'play',
    aliases: ['playsong', 'stream'],
    category: 'download',
    description: 'Play a song as a voice note',
    weight: 'heavy',
    usage: `${config.prefix}play <query or YouTube URL>`,
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const wait  = await sock.sendMessage(jid, { text: '▶️ Loading…' });
